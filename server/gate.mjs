export function gatePage(message = '', unavailable = false, nonce = '') {
  return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,nofollow,noarchive"><meta name="theme-color" content="#f2f7f6"><title>ROOM — Private preview</title><style>
*{box-sizing:border-box}html{color-scheme:light}body{margin:0;min-height:100svh;font-family:Arial,Helvetica,sans-serif;color:#16332f;background:radial-gradient(ellipse at 90% 0%,#d1e8e3 0%,transparent 60%),linear-gradient(130deg,#f6f8fc,#edf5f3);display:flex;flex-direction:column}header{padding:28px clamp(24px,5vw,80px);border-bottom:1px solid #2339511a;display:flex;align-items:center;justify-content:space-between}.logo{font-size:28px;font-weight:700;letter-spacing:-1.8px}.logo span{color:#087d79}.edition{font:12px monospace;letter-spacing:.1em;color:#60748c}main{flex:1;display:grid;place-items:center;padding:56px 24px}.panel{width:100%;max-width:460px;padding:clamp(28px,5vw,48px);border:1px solid #fff;background:#ffffffa8;box-shadow:0 24px 80px #34588712;border-radius:12px}.kicker{font:12px monospace;letter-spacing:.14em;color:#487b78;margin:0 0 28px}.lock{width:40px;height:40px;color:#087d79;margin-bottom:24px}h1{font-size:clamp(30px,5vw,38px);font-weight:500;letter-spacing:-1.5px;line-height:1.15;margin:0 0 16px}.intro{font-size:16px;line-height:1.6;color:#657387;margin:0 0 32px}label{display:block;font-size:14px;font-weight:600;margin-bottom:10px}input{width:100%;font:18px monospace;padding:15px;border:1px solid #bcc9dc;border-radius:5px;background:#f9fbff;color:#16332f}input:focus-visible,button:focus-visible{outline:3px solid #83c5b5;outline-offset:3px}button{width:100%;margin-top:18px;padding:16px 20px;border:0;border-radius:5px;color:white;background:#087d79;font:500 16px Arial,sans-serif;cursor:pointer;display:flex;align-items:center;justify-content:space-between}button:hover{background:#08645f}.error{font-size:14px;line-height:1.5;color:#a32438;margin:14px 0 0}.note{font-size:12px;line-height:1.6;color:#748398;margin:24px 0 0}footer{padding:24px;text-align:center;font:12px monospace;color:#7d8da4;letter-spacing:.05em}@media(max-width:450px){header{padding:22px 24px}.edition{font-size:12px}.panel{padding:28px}main{padding:32px 20px}}
